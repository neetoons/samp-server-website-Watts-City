	...
	<div class="portlet box blue">
		...
		<form action="<?php echo base_url(); ?>administrar/facciones/editar_miembro/validar_edicion" class="form-horizontal" method="post">
			...
			<div class="form-group">
			    ...
			    <div class="col-md-9">
				<select class="form-control" id="skin" name="skin" <?php if(!$skins) { echo 'readonly'; } ?>><?php foreach ($skins as $skin): ?>
				    <option value="<?php echo $skin->SkinID; ?>"><?php echo $skin->SkinID; ?></option><?php endforeach; ?>
				</select>
			    </div>
			</div>
			<div class="form-group">
