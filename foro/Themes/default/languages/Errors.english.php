...
$txt['user_format_notvalid'] = 'Please use the correct name format (Firstname_Lastname)';
$txt['register_server_fail'] = 'Could not register you in the game server';
$txt['user_profilepic_change'] = 'Could not synchronize your avatars';
$txt['error_mod_add'] = 'Could not add you as a moderator to your faction\'s board';
$txt['error_faction_board'] = 'Could not create a faction\'s board';
$txt['error_fac_change'] = 'Could not change your title to a faction title';
