...
function registerMember(&$regOptions, $return_errors = false)
{
	...
	if ( preg_match_all('/([A-Z][a-zA-Z]*)_([A-Z][a-zA-Z]*)/', $regOptions['username'], $matches) == false )
		$reg_errors[] = array('lang', 'user_format_notvalid');
	...
	$regOptions['username'] = $matches[0][0];
	...
	$regOptions['register_vars'] = array(
		...
		'real_name' => str_replace('_', ' ', $regOptions['username']),
